...
public abstract class AbstractEntityBackuper<Entity>
{
    ...
    protected readonly MundialitoDbContext mundialitoDbContext;

    public AbstractEntityBackuper(string directoryName, string entityName, MundialitoDbContext mundialitoDbContext)
    {
