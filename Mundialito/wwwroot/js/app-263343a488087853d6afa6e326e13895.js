...
angular.module('mundialitoApp').constant('Constants',
    {
        ...
        TABLE_GRID_OPTIONS: {
            ...
            columnDefs: [
                ...
                { field: 'YellowCards', displayName: 'Yellow Cards Marks', maxWidth: 55, resizable: false, headerCellTemplate: '<div class="ui-grid-cell-contents text-center" ng-click="col.sort($event)" style="cursor:pointer; margin-top:5px"><i class="fa fa-stop fa-2xl" style="color:#ffff00"></i><span ui-grid-visible="col.sort.direction" ng-class="{\'ui-grid-icon-up-dir\': col.sort.direction==\'asc\', \'ui-grid-icon-down-dir\': col.sort.direction==\'desc\'}"> </span></div>' },
                { field: 'Corners', displayName: 'Corners Marks', maxWidth: 55, resizable: false, headerCellTemplate: '<div class="ui-grid-cell-contents text-center" ng-click="col.sort($event)" style="cursor:pointer; margin-top:5px"><i class="fa fa-flag fa-xl"></i><span ui-grid-visible="col.sort.direction" ng-class="{\'ui-grid-icon-up-dir\': col.sort.direction==\'asc\', \'ui-grid-icon-down-dir\': col.sort.direction==\'desc\'}"> </span></div>' },
